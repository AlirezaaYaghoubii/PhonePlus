...
public class VafatAdapter extends RecyclerView.Adapter<VafatAdapter.MyViewHolder> {
    ...
    public VafatAdapter(Activity _activity, Context _context, ArrayList<EntityReport> _List) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_vafat, parent, false);
            ...
            ,Boolean _BirthDate,Boolean _MiladiDate,Boolean _Sen,Boolean _Mandeh,Boolean _Days,Boolean _Hour,EntityReport Itm)
    {
        ...
        if (_BirthDate)
            Val=Val+"\n"+"تاریخ وفات : "+Itm.get_DateWithMonthWord();
    ...
    private void Show_Before_Share(final Activity activity,final String Messenger,final EntityReport Itm)
    {
        ...
        View view2=alert.getLayoutInflater().inflate(R.layout.item_vafat_share, null);
