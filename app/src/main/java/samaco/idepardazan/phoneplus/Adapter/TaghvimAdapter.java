...
public class TaghvimAdapter extends RecyclerView.Adapter<TaghvimAdapter.MyViewHolder> {
    ...
    public TaghvimAdapter(Activity _activity, Context _context, ArrayList<EntityReport> _List) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_taghvim, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.TextView_TitleData.setText(Itm.get_DateTypeTitle());
            ...
            ,Boolean _BirthDate,Boolean _MiladiDate,Boolean _Sen,Boolean _Mandeh,Boolean _Days,Boolean _Hour,EntityReport Itm)
    {
        ...
        if (_BirthDate)
            Val=Val+"\n"+Itm.get_DateTypeTitle()+" "+Itm.get_DateWithMonthWord();
    ...
    private void Show_Before_Share(final Activity activity,final String Messenger,final EntityReport Itm)
    {
        ...
        View view2=alert.getLayoutInflater().inflate(R.layout.item_taghvim_share, null);
