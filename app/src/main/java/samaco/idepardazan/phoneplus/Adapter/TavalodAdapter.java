...
public class TavalodAdapter extends RecyclerView.Adapter<TavalodAdapter.MyViewHolder> {
    ...
    public TavalodAdapter(Activity _activity, Context _context, ArrayList<EntityReport> _List) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_tavalod, parent, false);
            ...
            ,Boolean _BirthDate,Boolean _MiladiDate,Boolean _Sen,Boolean _Mandeh,Boolean _Days,Boolean _Hour,EntityReport Itm)
    {
        ...
        if (_BirthDate)
            Val=Val+"\n"+"تاریخ تولد : "+Itm.get_DateWithMonthWord();
        ...
        if (_Mandeh)
            Val=Val+"\n"+"مانده به تولد : "+Itm.get_DateDiffMandeh();
    ...
    private void Show_Before_Share(final Activity activity,final String Messenger,final EntityReport Itm)
    {
        ...
        View view2=alert.getLayoutInflater().inflate(R.layout.item_tavalod_share, null);
