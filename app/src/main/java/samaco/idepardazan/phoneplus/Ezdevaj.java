...
import samaco.idepardazan.phoneplus.Fragment.Fragment_Ezdevaj;


public class Ezdevaj extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ezdevaj);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Fragment_Ezdevaj(),"");
