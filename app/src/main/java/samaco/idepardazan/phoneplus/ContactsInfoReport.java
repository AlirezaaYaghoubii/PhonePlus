...
public class ContactsInfoReport extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contacts_info_report);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Fragment_ContactsInfoReport(),"");
