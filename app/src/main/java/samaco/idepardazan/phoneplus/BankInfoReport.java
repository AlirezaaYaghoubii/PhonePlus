...
import samaco.idepardazan.phoneplus.Fragment.Fragment_BankInfoReport;
import samaco.idepardazan.phoneplus.Fragment.Fragment_ContactsInfoReport;


public class BankInfoReport extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bank_info_report);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Fragment_BankInfoReport(),"");
