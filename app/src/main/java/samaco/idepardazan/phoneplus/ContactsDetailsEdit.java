...
import samaco.idepardazan.phoneplus.Fragment.Fragment_ContactsDetails_Edit;
import samaco.idepardazan.phoneplus.Fragment.Fragment_ContactsList;


public class ContactsDetailsEdit extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contacts_details_edit);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Fragment_ContactsDetails_Edit(),"");
