...
import samaco.idepardazan.phoneplus.Fragment.Fragment_FullReport;
import samaco.idepardazan.phoneplus.Fragment.Fragment_Vafat;


public class FullReport extends ActionBarActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Fragment_FullReport(),"");
